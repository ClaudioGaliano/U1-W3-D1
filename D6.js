...
const es1 = function(string1, string2) {
  nuovastring1 = string1.slice(0, 3)
  nuovastring2 = string2.slice(-3)
  let stringMixed = string1.concat(string2)
  stringMixed.toUpperCase()
  console.log(stringMixed);
}
...
*/
const arrayEs3 = [0, 1, 2, 3, 4, 5]
const evenNumber = arrayEs3.filter((number) => {
  return number % 2 === 0
})
